...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click','.hanging-close, .modal-backdrop, .modal',
          function (event) {
            // Remove the src to remove the player, as this is the only
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a href="#" class="pull-left"><img src="images/web-icon.png"></a>
            <a class="navbar-brand" href="#">Trailer TUBE!</a>
          </div>
        </div>
      </div>
    </div>
...
def open_movies_page(movies):
    ...
    output_file = open('trailer_tube.html', 'w')
